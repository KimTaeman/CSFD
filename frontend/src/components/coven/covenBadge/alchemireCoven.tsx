...
const AlchemireCoven: React.FC<CovenProps> = ({ onClick, className = '' }) => {
  return (
    <div
    ...
    >
      <div className="flex flex-row items-center px-8 py-6">
        <div className="flex flex-1 flex-col items-start justify-start space-y-2">
          <h3 className="font-ribeye text-[1.5rem] text-white">Alchemire</h3>
          <p className="font-inter text-[0.7rem] text-white/80">Potion Brewer</p>
        </div>
        <div className="flex w-full min-w-40 justify-center md:max-w-40">
          <img src="/src/assets/alchemire.png" />
        </div>
      </div>
    </div>
  );
